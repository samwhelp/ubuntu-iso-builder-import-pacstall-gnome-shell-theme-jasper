...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-gnome-shell-theme-jasper"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-gnome-shell-theme-jasper/iso-profile
"
echo
